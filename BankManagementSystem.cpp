...
Features: - Create account - Deposit / Withdraw money - Check balance (PIN protected) - Change PIN - View account information - Close account - List all accounts - Data persistence using file handling (accounts.txt) 
*/ 
#include <iostream> 
#include <fstream> 
#include <sstream> 
...
/* 
    ...
    Features: 
      - Create account 
- Deposit / Withdraw money - Check balance (PIN protected) - Change PIN - View account information - Close account - List all accounts - Data persistence using file handling (accounts.txt) 
*/ 
#include <iostream> 
#include <fstream> 
#include <sstream> 
